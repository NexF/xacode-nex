import {
  ...
  import { CompletionKind, ResultEntry } from "./requests/requests";
  import {
    clearState,
    getCurrentPrefix,
    getCurrentSuggestion,
  } from "./suggestionSelector";
  import { trimEnd } from "./tools/utils";
  import {
  ...
  export async function setInlineSuggestion(
  ...
  export async function clearInlineSuggestionsState(): Promise<void> {
    await clearInlineDecoration();
    await clearState();
  }
